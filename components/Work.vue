      ...
      <div class="work" id="work">
        ...
        <div class="work__center center">
          <div class="work__wrap">
            <div class="work__stage stage stage_pink" data-aos="animation-scale-y">MY DEGREE</div>
            <h2 class="work__title title h1" data-aos="animation-scale-y" data-aos-delay="150">The certificate <br> I got from Google.</h2>
            <div class="work__text" data-aos="animation-scale-y" data-aos-delay="300">The international degree that I received in 2022 from the big company Google.</div>
            <NuxtLink :to="{ path: '/',hash:'#cases'}" class="scroll js-scroll" data-aos="animation-scale-y">
