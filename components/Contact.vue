<template>
            <div class="contacts__center center" id="contact">
              <div class="contacts__container">
                <div class="contacts__wrap">
                  <div class="contacts__stage stage" data-aos="animation-scale-y">Be in touch with me</div>
                ...
                <div class="contacts__row">
                  <div class="contacts__details" data-aos="animation-translate-y"><a class="contacts__line" href="mailto:sohil123dhh@gmail.com">
                      ...
                      <div class="contacts__text">sohil123dhh@gmail.com</div></a>
                    <div class="contacts__line">
                      ...
                      <div class="contacts__text">+98 930 951 7350</div></a>
                  </div>
                  <form class="contacts__form" data-aos="animation-translate-y" data-aos-delay="200">
                    ...
                    <div class="contacts__field field">
                      <div class="field__wrap">
                        <select class="field__select" name="question">
                          ...
                          <option>I have a complaint against you</option>
                          <option>I wanted to thank you</option>
                        </select>
                        <div class="field__icon">
                    ...
                    <div class="contacts__btn">
                      <button class="btn btn_purple"><span class="btn__text">Let’s Go</span>
                ...
                <div class="contacts__social">
                  <div class="contacts__box" data-aos="animation-translate-y">
                    <a target="_blank" class="contacts__link" href="https://instagram.com/sohil._.pro">
                  ...
                  <div class="contacts__box" data-aos="animation-translate-y" data-aos-delay="150">
                    <a target="_blank" class="contacts__link" href="https://t.me/sohilpro">
                  ...
                  <div class="contacts__box" data-aos="animation-translate-y" data-aos-delay="300">
                    <a target="_blank" class="contacts__link" href="https://www.youtube.com/channel/UCzNNhW6em5DZ-ue3v410JwA">
                    <svg class="svg-icon" width="20" height="20" viewBox="0 0 20 20">
                      ...
                      <div class="contacts__text">youtube</div>
                    </a>
                  </div>
                  <div class="contacts__box" data-aos="animation-translate-y" data-aos-delay="450">
                    <a target="_blank" class="contacts__link" href="https://twitter.com/sohil_khbz">
                    <svg class="svg-icon" width="20" height="20" viewBox="0 0 20 20">
